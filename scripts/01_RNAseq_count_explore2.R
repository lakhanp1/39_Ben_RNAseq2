...
# samplesSet <- c("DMSO_12hr_1", "DMSO_24hr_2", "Tet_5_12hr_2", "Tet_5_24hr_2", "Tet_15_12hr_2", "Tet_15_24hr_1", "Tet_m_5_12hr_2", "Tet_m_5_24hr_1", "Tet_m_15_12hr_2", "Tet_m_15_24hr_1")

samplesSet <- c("DMSO_12hr_2", "DMSO_24hr_1", "Tet_5_12hr_1", "Tet_5_24hr_1", "Tet_15_12hr_1", "Tet_15_24hr_2", "Tet_m_5_12hr_1", "Tet_m_5_24hr_2", "Tet_m_15_12hr_1", "Tet_m_15_24hr_2" )
...
plot_dist <- ComplexHeatmap::Heatmap(
  matrix = sampleDistMatrix[samplesSet, samplesSet],
...
# png(filename = paste(outPrefix, "2.distance_heatmap.png", sep = ""),
#     width = 3000, height = 3000, res = 300)
pdf(file = paste(outPrefix, "2.distance_heatmap.pdf", sep = ""), width = 10, height = 10)
draw(plot_dist,
...
normCountMat <- as.matrix(rldCount[, c(exptInfo$sampleId), drop = FALSE])[, samplesSet]
...
pdf(file = paste(outPrefix, "2.rld_PCA.pdf", sep = ""), width = 8, height = 8)
# png(filename = paste(outPrefix, "1.rld_PCA.png", sep = ""), width = 4000, height = 3000, res = 400)
pcaPlot
dev.off()
